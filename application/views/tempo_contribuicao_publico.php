...
<link href="<?= base_url('assets/css/style_form.css')?>" rel="stylesheet" />
<title><?= $titulo?></title>
            ...
            <div class="card-body text-center">
              ...
              <thead class="thead-dark">
                <tr>
                  ...
                  <th scope="col">Tempo que Resta no Serviço Público</th>
                  <th scope="col">Tempo que Resta de Permanência no Cargo</th>
                  </tr>
              </thead>
              <tbody>
                  <tr>
                  ...
                  <?php if($tempo_servico_meses == 0){?>
                    <td><?= $tempo_servico_anos ?> anos</td>
                  <?php }elseif($tempo_servico_meses == 12){?>
                    <td><?= $tempo_servico_anos ?> anos</td>
                  <?php }else{?>
                  <td><?= $tempo_servico_final ?> anos e <?= $tempo_servico_meses ?> meses</td>
                  <?php }?>

                  <?php if($tempo_cargo_meses == 0){?>
                    <td><?= $tempo_cargo_anos ?> anos</td>
                  <?php }elseif($tempo_cargo_meses == 12){?>
                    <td><?= $tempo_cargo_anos ?> anos</td>
                  <?php }else{?>
                  <td><?= $tempo_cargo_final ?> anos e <?= $tempo_cargo_meses ?> meses</td>
                  <?php }?>
                  </tr>
              </tbody>
              </table><br><br>
