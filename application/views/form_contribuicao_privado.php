    ...
    <div class="col-6"><br><br>
      <div class="card shadow mb-4 text-center">
        ...
        <h1 class="h3 mb-2 text-gray-900 text-center">Cálculo do Tempo de Contribuição</h1><br>
          <form action="<?= base_url('')?>index.php/calculacomumprivado/contribuicao_comum" method="post" class="user">
          <div class="form-group">
            <select class="form-select" class="form-control" name="trabalho" aria-label="Default select example">
              <option selected>---</option>
              <option value="1">Tabalhador Privado Urbano</option>
              <option value="3">Trabalhador Rural</option>
              <option value="4">Professor Privado</option>
            </select><br>
          </div>     
          <div class="form-group">
